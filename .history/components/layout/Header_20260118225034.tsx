    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-lg border-b border-border">
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between h-20">
          {/* Logo */}
          <Link href="/" className="flex-shrink-0 w-[180px]">
            <Image src="/marvar-tarkvara.svg" alt="MarVar logo" width={180} height={50} className="h-14 w-auto" />
          </Link>
          ...
          <div className="hidden md:flex items-center justify-end gap-4 w-[180px]">
            ...
            <Button variant="accent" asChild>
              <Link href="/kontakt">{t("nav.cta")}</Link>
            </Button>
          </div>
