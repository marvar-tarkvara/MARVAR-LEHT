...
const translations: Record<Language, Record<string, string>> = {
  et: {
    ...
    "trust.experience.title": "5+ aastat kogemust",
    ...
    "about.story.p1": "MarVariks sai alguse kirgliku veebiarenduse entusiastide ideest luua midagi enamat kui tavaline veebiagentuuri. Me usume, et iga ettevõte väärib veebilehte, mis peegeldab nende unikaalsust ja aitab neil silma paista.",
  ...
  en: {
    ...
    "about.story.p1": "MarVariks started from the idea of passionate web development enthusiasts to create something more than an ordinary web agency. We believe that every business deserves a website that reflects their uniqueness and helps them stand out.",
